...
function changeColor(){
  ...
  const hR = Number(form.colorHeadBgR.value);
  const hG = Number(form.colorHeadBgG.value);
  const hB = Number(form.colorHeadBgB.value);
  const hA = Number(form.colorHeadBgA.value);
  const bR = Number(form.colorBaseBgR.value);
  const bG = Number(form.colorBaseBgG.value);
  const bB = Number(form.colorBaseBgB.value);
  const bA = Number(form.colorBaseBgA.value);
  document.getElementById('colorHeadBgRValue').innerHTML = hR;
  document.getElementById('colorHeadBgGValue').innerHTML = hG;
  document.getElementById('colorHeadBgBValue').innerHTML = hB;
  document.getElementById('colorHeadBgAValue').innerHTML = hA;
  document.getElementById('colorBaseBgRValue').innerHTML = bR;
  document.getElementById('colorBaseBgGValue').innerHTML = bG;
  document.getElementById('colorBaseBgBValue').innerHTML = bB;
  document.getElementById('colorBaseBgAValue').innerHTML = bA;
  
  const boxes = document.querySelectorAll('.box');
  boxes.forEach(function(box) {
    box.style.backgroundImage = customOn ? 'linear-gradient(to bottom, rgba('+hR+','+hG+','+hB+','+hA+') 0, rgba('+bR+','+bG+','+bB+','+bA+') 2.5rem)' : '';
  });
  document.getElementById('area-name').style.backgroundImage = customOn ? 'linear-gradient(to bottom, rgba('+hR+','+hG+','+hB+','+hA+'), rgba('+bR+','+bG+','+bB+','+bA+'))' : '';
}
