...
## ●各種ファイルへのパス
  ...
  our $lib_edit_char   = $::core_dir . '/lib/gc/edit-chara.pl';  # 編集画面
  our $lib_calc_char   = $::core_dir . '/lib/gc/calc-chara.pl';  # 保存処理
  our $lib_view_char   = $::core_dir . '/lib/gc/view-chara.pl';  # シート表示
  our $lib_palette_sub = $::core_dir . '/lib/gc/palette-sub.pl'; # チャットパレット
  our $lib_list_char   = $::core_dir . '/lib/gc/list-chara.pl';  # 一覧
  our $lib_json_sub    = $::core_dir . '/lib/gc/json-sub.pl';    # JSON出力
  our $lib_convert     = $::core_dir . '/lib/gc/convert.pl';     # コンバート
