  ...
  <section id="section-common">
      ...
      <div class="box" id="status">
        ...
        <table class="edit-table" id="status-table">
          ...
          <tbody>
            ...
            @{[ renderTemplateLoop(
              { id => 'status-grow', startNum => 2, numKey => 'level' },
              sub ($lv) {
                return <<~"ROW";
                <tr id="status-grow${lv}" class="status-grow" @{[ displayGrowRow($lv) ]}>
                  <th>成長:${lv}レベル
                  <td class="Str">@{[ checkbox "sttStrGrow${lv}",'+1',"changeGrow($lv)" ]}
                  <td class="Ref">@{[ checkbox "sttRefGrow${lv}",'+1',"changeGrow($lv)" ]}
                  <td class="Per">@{[ checkbox "sttPerGrow${lv}",'+1',"changeGrow($lv)" ]}
                  <td class="Int">@{[ checkbox "sttIntGrow${lv}",'+1',"changeGrow($lv)" ]}
                  <td class="Mnd">@{[ checkbox "sttMndGrow${lv}",'+1',"changeGrow($lv)" ]}
                  <td class="Emp">@{[ checkbox "sttEmpGrow${lv}",'+1',"changeGrow($lv)" ]}
                ROW
              }
            ) ]}
          ...
          <tr>
            @{[ map {
              ...
              join '', map {
                ...
                '<dl class="left">'
                . '<dt>'.$skill
                . ( ($skill =~ /:$/) ? input("skill${stt}${i}LabelBranch") : '' )
                . '<dd>'
                . qq|<span id="skill${stt}${i}-text">|
                . ('●' x $pc{"skill${stt}${i}Lv"})
    ...
    <details class="box" id="class-ability" $open{classAbility}>
      ...
      <table class="edit-table line-tbody no-border-cells ability-table" id="class-ability-table">
        ...
        @{[ renderAddDelButtons('class-ability') ]}
      </details>
    ...
    <details class="box" id="works-ability" $open{worksAbility}>
      ...
      @{[ renderAddDelButtons('works-ability') ]}
    </details>
    ...
    <details class="box" id="action-sets" $open{actionSets}>
      ...
      @{[ renderAddDelButtons('action-set') ]}
    </details>
    ...
    <details class="box" id="reaction-sets" $open{reactionSets}>
      ...
      @{[ renderAddDelButtons('reaction-set') ]}
    </details>
