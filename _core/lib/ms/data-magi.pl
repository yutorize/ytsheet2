...
my @pcMagi = (
  ...
  },
  {
    ...
    target => '1～2体',
    cond   => '1～6',
    note   => '対象に5点のダメージを与える。ダメージの適用後、［マリョク］を1上げる。',
  },
  {
    name   => '怪力無双',
    timing => 'サブ',
  ...
  },
  {
    ...
    target => '単体',
    cond   => '2・4・6・8・10・12',
    note   => '対象が与えるダメージを5点増やす。ラウンドに1回使える。',
  },
  {
    name   => '祝福の風',
    timing => 'ダメージ増加',
  ...
  },
  {
    ...
    target => '単体',
    cond   => '2・4・6・8・10・12',
    note   => 'ダメージ適用の直前に使用する。対象に与えられるダメージを、代わりにお前が受ける。その際、お前が受けるダメージを3点減らす。自身不可。',
  },
  {
    name   => '結界',
    timing => 'ダメージ減少',
  ...
  },
  {
    ...
    target => '自身',
    cond   => 'なし',
    note   => 'お前の【耐久値】に＋3し、受けるダメージを常に2点減少する。お前の【イニシアチブ】は［1D－2］で決定する（最低1）。',
  },
);
...
my @clanMagi = (
  ...
  },
  {
    ...
    target => 'クラン全員',
    cond   => 'なし',
    note   => '［ロケアクション］が終わるまで、クラン全員が攻撃で与えるダメージを3点増やす。セッションに1回使える。',
  },
  {
    name   => 'クラン体操第一',
    timing => '開始',
    target => 'クラン全員',
    cond   => 'なし',
    note   => '［ロケアクション］が終わるまで、クラン全員が受けるダメージを3点減らす。セッションに1回使える。',
  },
  {
    name   => '戦闘集団',
    timing => '常時',
