...
our %class = (
  ...
  'アルケミスト' => {
    ...
    craft => {
      ...
      data => [
        ...
        [5,'リーンフォース','[赤][補]'],
        [10,'クレイフィールド','[黒]'],
        [10,'コンバインマテリアル','[白][黒][補][準]'],
        [10,'スラッシュフィールド','[白]'],
        [10,'デラックスマテリアル','[赤][緑][補][準]'],
        [10,'バリアフィールド','[金]'],
        [10,'フレイムフィールド','[赤]'],
        [10,'レストフィールド','[緑]'],
        [16,'プリズムカーテン','2.0'],
  ...
  'ビブリオマンサー' => {
    ...
    magic => {
      ...
      stt => '知力',
      data => [
        [1,'アクス＝マリスティアス－悪意の針－','[補]'],
        [1,'ウェルム＝リイェクタス－拒絶の障壁－'],
        [1,'コルプス＝レストラーレ－肉体修復－'],
        [1,'スパティウム＝オルクス－空間視認－'],
        [1,'ネブラ＝ウェネーヌムス－猛毒の霧－'],
        [1,'ランケア＝ルイナス－破滅の槍－'],
        [4,'アクティオ＝エクソキスムス－退魔活性－','[補]'],
        [4,'アディシオ＝エレメントゥム－属性付加－','[補]'],
        [4,'マギカ＝アウゲータス－魔力増強－','[補]'],
        [4,'パラーレ＝アプスコンディートゥス－隠匿対応－'],
        [4,'プルケリトゥード－容姿端麗－'],
        [4,'ルクス＝トライキエンス－貫く光条－'],
        [7,'モメント＝レストラーレ－瞬間修復－','[補]'],
        [7,'アトモス＝イラプティオ－大気爆発－'],
        [7,'マグナ＝サルトゥス－大跳躍－'],
        [7,'マグナ＝ペルセプティオ－大知覚－'],
        [7,'ランケア＝ダムナトリウス－断罪の槍－'],
        [7,'レナトゥス＝イニシアトゥス－再生起動－'],
        [10,'コングラーレ＝ラピダス－先手凍結－','[準]'],
        [10,'ケレリタス＝ウォラートゥス－高速飛行－'],
        [10,'デネブラス＝カイエンデンス＝ルミナス－闇を裂く閃光－'],
        [10,'デフェンシオス＝ペルフェクタス－完全防護－'],
        [10,'モルス＝ウィルトゥアリス－仮想の死－'],
        [13,'エンシス＝ヴァリアビリス－多形の刃－','[補]'],
        [13,'スパティウム＝テレポータス－空間転移－'],
        [13,'モルス＝テンペスタス－死の嵐－'],
        [13,'ランケア＝フェリオデウス－神殺の槍－'],
        [13,'ルクス＝サンクトゥム＝アドヴェントゥス－聖魔の光束－'],
      ],
    },
    feats => [
      ['ルーンマスター',11],
  ...
  '侍' => {
    ...
    evaUnlock => { lv => 1 },
    package  => {
      Tec => { name => '技巧', stt => 'A', mod => -2 },
      Agi => { name => '運動', stt => 'B', mod => -2, forestall => 1 },
      Obs => { name => '観察', stt => 'E', mod => -2 },
    },
    feats => [
      #['タフネス',7],
      ['追加攻撃',1],
  ...
  '呪術師' => {
    ...
    package  => {
      Kno => { name => '知識', stt => 'E', mod => -2, monsterLore => 1 },
    },
    feats => [
      #['ルーンマスター',11],
      ['鋭い目',5],
  ...
  '巫覡' => {
    ...
    id       => 'Fug',
    eName    => 'fugeki',
    accUnlock => { lv => 1, mod => -2 },
    evaUnlock => { lv => 1, mod => -2 },
    magic => {
      jName => '巫寄せ',
      eName => 'fuyose',
    },
