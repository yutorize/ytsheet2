...
HTML
    foreach ('TMPL',1 .. $pc{chatPaletteInsertNum}){
        ...
        $html .= "<li>"
            . ::selectBox("chatPaletteInsert${_}Position", 'setChatPalette', 'def=|<先頭>','general|<非戦闘系の直後>','common|<一般技能の直後>','drug|<薬草・ポーションの直後>','feats|<宣言特技の直後>','magic|<魔法系の直後>','attack|<武器攻撃系の直後>','defense|<抵抗回避の直後>')
            . "に挿入"
