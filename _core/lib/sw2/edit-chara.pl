          ...
          <ul class="edit-table side-margin">
            @{[
              map {
                ...
                qq|<li id="combat-feats-lv$id" data-lv="$dataset" class="select-input |
        ...
        <div class="box" id="package">
          ...
          @{[
            map {
              ...
              <<~TBODY
              <tbody id="package-$c_en" @{[ $c_id =~ /FC[0-9]+/ ? qq|data-free-class="$1"|:'' ]}@{[ display $pc{"lv$c_id"} ]}>
              ...
              TBODY
            } grep { $data::class{$_}{package} } @allClassNames
          ]}
          </table>
        </div>
      </div>
